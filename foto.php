...
<body class="twoColHybLtHdr">
  ...
  <tr>
    <td><div align="center">
      <p class="Estilo20"><span class="Estilo1">F</span>detector</p>
      <p class="Estilo20">- Debes ingresar la url de la imagen del perfil que desees <span class="Estilo20">averiguar. </span></p>
      <p><span class="Estilo20">Pasos: Ingresa la url, click en comprar y listo tendras el nombre del due&ntilde;o del perfi</span>l. </p>
      <form method="GET">
        Ingresa url:
